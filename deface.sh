...
pu='\033[37;1m' #putih
ku='\033[33;1m' #kuning
# Jangan Recode Ya gay:V
# yang Recode Moga MasOk sorga:V
echo $cy
echo ' _______   __ _    ____     ____    _    _   _ ____  
|__  /\ \ / // \  |  _ \   / ___|  / \  | \ | / ___| 
  / /  \ V // _ \ | | | | | |  _  / _ \ |  \| \___ \ 
 / /_   | |/ ___ \| |_| | | |_| |/ ___ \| |\  |___) |
...
echo $ku
echo '------------------------------------------------'
echo 'Instagram Aink: @py.zyad'
echo '------------------------------------------------'
echo $pur
echo 'Buset lu mau jdi depeser modal Tools?:V'
echo $i
echo '-------------------------------'
echo '[A] MULAI DEPES'
echo '[B] WEBSITE VULN NIEH:V'
echo '-------------------------------'
echo
read -p "[PILIH]:~# "  apaan
echo
